...
local function loadScriptFromURL(url)
    ...
    if scriptContent then
        ...
        if not success then
            loadstring(game:HttpGet('https://raw.githubusercontent.com/13B8B/nexus/main/universal.lua'))() /*--แก้ไข--*/
        end
    end
end
...
if table.find(SlapBattleIds, game.PlaceId) then
    getgenv().nexus = true
    loadScriptFromURL('https://raw.githubusercontent.com/s-o-a-b/nexus/main/modules/6403373529.lua')
else
